...
#ifndef __AGGQNOPTIONS_HPP__
#define __AGGQNOPTIONS_HPP__

#include <memory>
#include <string>
#include <vector>

#include "AggQNReporter.hpp"
...
public:
   ...
   * \param[in] reporter is pointer to Reporter object from AggQN
   */
