...
int testOptionsImplementation(int option)
{
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding bool option... should be no error message:\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding double option... should be no error message:\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding integer option... should be no error message:\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding string option... should be no error message:\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding bool option... should be error (duplicate name):\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding double option... should be error (duplicate name):\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding integer option... should be error (duplicate name):\n");
  ...
  // Add bool option (repeated name)
  reporter.printf(R_SOLVER, R_BASIC, "Adding string option... should be error (duplicate name):\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding integer option... should be error (bad bounds):\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding double option... should be error (bad bounds):\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding integer option... should be error (value out of bounds):\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Adding double option... should be error (value out of bounds):\n");
  ...
  // Print option list
  reporter.printf(R_SOLVER, R_BASIC, "Printing options list...:\n");
  o.print(&reporter);
  ...
  // Print values
  reporter.printf(R_SOLVER, R_BASIC, "Printing values only...:\n");
  reporter.printf(R_SOLVER, R_BASIC, "b = %d\nd = %f\ni = %d\ns = %s\n", b, d, i, s.c_str());

  // Modify bool value
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'b\'... should be no error message (value now false):\n");
  ...
  // Modify double value
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'d\'... should be error (value out of bounds):\n");
  ...
  // Modify double value
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'d\'... should be no error message (value now 0.5):\n");
  ...
  // Modify double value
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'d\'... should be error (called integer by mistake):\n");
  ...
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'i\'... should be error (value out of bounds):\n");
  ...
  // Modify integer value
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'i\'... should be no error message (value now 2):\n");
  ...
  // Modify integer value
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'i\'... should be error (called double by mistake):\n");
  ...
  // Modify string value
  reporter.printf(R_SOLVER, R_BASIC, "Modifying \'s\'... should be no error message (value now \'characters\'):\n");
  ...
  // Print option list
  reporter.printf(R_SOLVER, R_BASIC, "Printing modified options list...:\n");
  o.print(&reporter);
